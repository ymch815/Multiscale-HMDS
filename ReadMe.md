...
- **Algorithm intuition**: See [1-Overview.md](docs/1-Overview.md) for conceptual background
- **Example usage**: See [2-Example Usage.md](docs/2-Example%20Usage.md) for hands-on tutorials
- **Interactive examples**: Run [example-usage.ipynb](docs/example-usage.ipynb) for working code for 2-Example Usage.md
- **Parameter selection**:Review [3-Parameters](docs/3-Parameters.md) for hyperparameter selection advice
